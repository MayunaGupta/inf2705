   ...
   void definir()
   {
      ...
      else
      {
        ...
        // matrVisu.Rotate(90,0,1,0);
         matrVisu.Rotate(-theta-90,0,1,0);
...
void afficherCorps()
{
   ...
   matrModel.PushMatrix();{
      ...
      case 1: // une bestiole (plutôt extraterrestre)
         ...
         matrModel.PushMatrix();{
            matrModel.Translate( bestiole.position[0], bestiole.position[1], bestiole.position[2]+bestiole.taille ); // (bidon) À MODIFIER
            glUniformMatrix4fv( locmatrModel, 1, GL_FALSE, matrModel );
            afficherSphere();
         }matrModel.PopMatrix(); glUniformMatrix4fv( locmatrModel, 1, GL_FALSE, matrModel );
         break;
...
void afficherPattes()
{
   ...
   matrModel.PushMatrix();{
      ...
      matrModel.Translate(0,-bestiole.taille/M_SQRT2,-bestiole.taille/M_SQRT2-bestiole.taille/2);
